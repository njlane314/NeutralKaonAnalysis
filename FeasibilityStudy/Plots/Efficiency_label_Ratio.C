void Efficiency_label_Ratio()
{
//=========Macro generated from canvas: c1/c1
//=========  (Tue Nov  7 10:10:46 2023) by ROOT version 6.12/06
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.625,-8.005618,5.625,72.05056);
   pad1->SetFillColor(0);
   ...
   TH1D *h_Before_stack_1 = new TH1D("h_Before_stack_1"," (total)",5,0,5);
   h_Before_stack_1->SetBinContent(1,2);
   h_Before_stack_1->SetBinContent(2,2);
   h_Before_stack_1->SetBinContent(3,18);
   h_Before_stack_1->SetBinContent(4,57);
   h_Before_stack_1->SetBinContent(5,35);
   h_Before_stack_1->SetBinContent(6,65);
   h_Before_stack_1->SetEntries(179);
   ...
   TH1D *h_After_stack_2 = new TH1D("h_After_stack_2"," (passed)",5,0,5);
   h_After_stack_2->SetBinContent(2,1);
   h_After_stack_2->SetBinContent(3,7);
   h_After_stack_2->SetBinContent(4,18);
   h_After_stack_2->SetBinContent(5,12);
   h_After_stack_2->SetBinContent(6,10);
   h_After_stack_2->SetEntries(48);
   ...
   hs->Draw("nostack e0");
   TGaxis *gaxis = new TGaxis(5,0,5,71.25,0,0.8960176,510,"+L");
   ...
   TH1F *Graph_Graph3001 = new TH1F("Graph_Graph3001","Graph",100,0.1,4.9);
   Graph_Graph3001->SetMinimum(0);
   Graph_Graph3001->SetMaximum(65.3125);

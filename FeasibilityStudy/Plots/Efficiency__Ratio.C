...
//=========  (Tue Nov  7 10:56:56 2023) by ROOT version 6.12/06
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.125,-25.14045,1.125,226.264);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(223.75);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",10,0,1);
   hs_stack_1->SetMinimum(0);
   hs_stack_1->SetMaximum(223.75);
   ...
   h_Before_stack_1->SetBinContent(1,179);
   ...
   h_After_stack_2->SetBinContent(1,11);
   h_After_stack_2->SetEntries(11);
   ...
   hs->Draw("nostack e0");
   TGaxis *gaxis = new TGaxis(1,0,1,223.75,0,1.008,510,"+L");
   ...
   Graph_Graph3001->SetMinimum(9.024153);
   Graph_Graph3001->SetMaximum(204.1015);

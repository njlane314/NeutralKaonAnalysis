void invariant_mass_fhc_FV_muon_pion_pair_ByBackground()
{
...
// ------------>Primitives in pad: p_plot
   ...
   h_errors__4->SetBinContent(1,1.981921);
   h_errors__4->SetBinContent(2,9.596111);
   h_errors__4->SetBinContent(3,3.475004);
   h_errors__4->SetBinContent(4,1.179588);
   h_errors__4->SetBinError(1,0.10262);
   h_errors__4->SetBinError(2,0.2258065);
   h_errors__4->SetBinError(3,0.1358834);
   h_errors__4->SetBinError(4,0.07916879);
   h_errors__4->SetMinimum(0);
   h_errors__4->SetMaximum(12.2774);
   h_errors__4->SetEntries(3091);
   ...
   hs_stack_2->SetMaximum(10.07592);
   ...
   h_BackgroundSignal_stack_1->SetBinContent(1,0.6482423);
   h_BackgroundSignal_stack_1->SetBinContent(2,3.528138);
   h_BackgroundSignal_stack_1->SetBinContent(3,1.493083);
   h_BackgroundSignal_stack_1->SetBinContent(4,0.4675846);
   h_BackgroundSignal_stack_1->SetBinError(1,0.0586891);
   h_BackgroundSignal_stack_1->SetBinError(2,0.1369183);
   h_BackgroundSignal_stack_1->SetBinError(3,0.08906984);
   h_BackgroundSignal_stack_1->SetBinError(4,0.04984468);
   h_BackgroundSignal_stack_1->SetEntries(1168);
   ...
   h_BackgroundOther_stack_2->SetBinContent(1,1.333679);
   h_BackgroundOther_stack_2->SetBinContent(2,6.067973);
   h_BackgroundOther_stack_2->SetBinContent(3,1.981921);
   h_BackgroundOther_stack_2->SetBinContent(4,0.7120038);
   h_BackgroundOther_stack_2->SetBinError(1,0.08418105);
   h_BackgroundOther_stack_2->SetBinError(2,0.1795604);
   h_BackgroundOther_stack_2->SetBinError(3,0.10262);
   h_BackgroundOther_stack_2->SetBinError(4,0.06150776);
   h_BackgroundOther_stack_2->SetEntries(1923);
   ...
   h_errors__5->SetBinContent(1,1.981921);
   h_errors__5->SetBinContent(2,9.596111);
   h_errors__5->SetBinContent(3,3.475004);
   h_errors__5->SetBinContent(4,1.179588);
   h_errors__5->SetBinError(1,0.10262);
   h_errors__5->SetBinError(2,0.2258065);
   h_errors__5->SetBinError(3,0.1358834);
   h_errors__5->SetBinError(4,0.07916879);
   h_errors__5->SetMinimum(0);
   h_errors__5->SetMaximum(12.2774);
   h_errors__5->SetEntries(3091);
   ...
   h_errors_copy__6->SetBinContent(1,1.981921);
   h_errors_copy__6->SetBinContent(2,9.596111);
   h_errors_copy__6->SetBinContent(3,3.475004);
   h_errors_copy__6->SetBinContent(4,1.179588);
   h_errors_copy__6->SetBinError(1,0.10262);
   h_errors_copy__6->SetBinError(2,0.2258065);
   h_errors_copy__6->SetBinError(3,0.1358834);
   h_errors_copy__6->SetBinError(4,0.07916879);
   h_errors_copy__6->SetMinimum(0);
   h_errors_copy__6->SetMaximum(12.2774);
   h_errors_copy__6->SetEntries(3091);

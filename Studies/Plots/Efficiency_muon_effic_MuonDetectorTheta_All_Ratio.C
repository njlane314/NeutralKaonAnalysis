void Efficiency_muon_effic_MuonDetectorTheta_All_Ratio()
{
...
// ------------>Primitives in pad: pad1
   ...
   hs->SetName("hs");
   hs->SetTitle(";Muon #theta;Events/bin");
   hs->SetMaximum(6.987201);
   
   TH1F *hs_stack_2 = new TH1F("hs_stack_2","",30,0,3.1415);
   hs_stack_2->SetMinimum(0);
   hs_stack_2->SetMaximum(6.987201);
   hs_stack_2->SetDirectory(0);
   hs_stack_2->SetStats(0);

   ci = TColor::GetColor("#000099");
   hs_stack_2->SetLineColor(ci);
   hs_stack_2->GetXaxis()->SetTitle("Muon #theta");
   ...
   1.231526,
   1.547135};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(29,Graph0_fx3002,Graph0_fy3002,Graph0_felx3002,Graph0_fehx3002,Graph0_fely3002,Graph0_fehy3002);
   grae->SetName("Graph0");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph3002 = new TH1F("Graph_Graph3002","Graph",100,0,3.39282);
   Graph_Graph3002->SetMinimum(0.2550339);
   Graph_Graph3002->SetMaximum(6.328816);

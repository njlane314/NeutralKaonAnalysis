void Efficiency_muon_effic_MuonDetectorPhi_All_Ratio()
{
//=========Macro generated from canvas: c1/c1
//=========  (Mon Feb 12 09:41:49 2024) by ROOT version 6.12/06
...
// ------------>Primitives in pad: pad1
   ...
   hs->SetName("hs");
   hs->SetTitle(";Muon #phi;Events/bin");
   hs->SetMaximum(5.406447);
   
   TH1F *hs_stack_3 = new TH1F("hs_stack_3","",30,-3.1415,3.1415);
   hs_stack_3->SetMinimum(0);
   hs_stack_3->SetMaximum(5.406447);
   hs_stack_3->SetDirectory(0);
   hs_stack_3->SetStats(0);

   ci = TColor::GetColor("#000099");
   hs_stack_3->SetLineColor(ci);
   hs_stack_3->GetXaxis()->SetTitle("Muon #phi");
   ...
   0.2851901,
   0.2010173};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(30,Graph0_fx3003,Graph0_fy3003,Graph0_felx3003,Graph0_fehx3003,Graph0_fely3003,Graph0_fehy3003);
   grae->SetName("Graph0");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph3003 = new TH1F("Graph_Graph3003","Graph",100,-3.64414,3.64414);
   Graph_Graph3003->SetMinimum(2.24026);
   Graph_Graph3003->SetMaximum(4.711292);

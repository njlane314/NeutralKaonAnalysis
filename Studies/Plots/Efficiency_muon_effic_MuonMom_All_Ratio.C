...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.7500001,-0.1123596,6.75,1.011236);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle(";Muon Momentum (GeV/c);Events/bin");
   hs->SetMaximum(0);
   
   TH1F *hs_stack_1 = new TH1F("hs_stack_1","",15,0,6);
   ...
   TH1D *h_Before_stack_1 = new TH1D("h_Before_stack_1"," (total)",15,0,6);
   ...
   TH1D *h_After_stack_2 = new TH1D("h_After_stack_2"," (passed)",15,0,6);
   h_After_stack_2->SetEntries(4018);
   ...
   hs->Draw("nostack e0");
   TGaxis *gaxis = new TGaxis(6,0,6,1,0,0,510,"+L");

void Efficiency_invariant_mass_fhc_FV_muon_pion_pair_DecayProtonMomentum_All_Ratio()
{
//=========Macro generated from canvas: c1/c1
//=========  (Thu Feb  1 05:40:50 2024) by ROOT version 6.12/06
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(0.15,-0.1123596,1.65,1.011236);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle(";True Decay Proton Momentum (GeV/c,Mode,POT);Events");
   hs->SetMaximum(0);
   
   TH1F *hs_stack_9 = new TH1F("hs_stack_9","",60,0.3,1.5);
   ...
   hs_stack_9->GetXaxis()->SetTitle("True Decay Proton Momentum (GeV/c,Mode,POT)");
   ...
   TH1D *h_Before_stack_1 = new TH1D("h_Before_stack_1"," (total)",60,0.3,1.5);
   ...
   h_Before_stack_1->GetXaxis()->SetTitle("True Decay Proton Momentum (GeV/c)");
   ...
   TH1D *h_After_stack_2 = new TH1D("h_After_stack_2"," (passed)",60,0.3,1.5);
   ...
   h_After_stack_2->GetXaxis()->SetTitle("True Decay Proton Momentum (GeV/c)");
   ...
   hs->Draw("nostack e0");
   TGaxis *gaxis = new TGaxis(1.5,0,1.5,1,0,0,510,"+L");

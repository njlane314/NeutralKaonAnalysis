...
// ------------>Primitives in pad: p_plot
   ...
   h_PureKaonSignalNuMuCCKaon_stack_1->SetEntries(57);
   ...
   h_PureKaonSignalNuMuCCKaonMultiPion_stack_2->SetEntries(114);
   ...
   h_PureKaonSignalNuMuCCKaonHyperon_stack_3->SetEntries(203);
   ...
   h_PureKaonSignalNuMuCCKaonHyperonMultiPion_stack_4->SetEntries(469);
   ...
   h_PureKaonOtherNuMuCC_stack_5->SetEntries(457);
   ...
   h_PureKaonNuECC_stack_6->SetEntries(11);
   ...
   h_PureKaonNC_stack_7->SetEntries(311);
   ...
   h_PureKaonOutFV_stack_8->SetEntries(95);
   ...
   TH1D *h_PureKaonBeamOff_stack_9 = new TH1D("h_PureKaonBeamOff_stack_9","",4,0.2,0.6);
   ...
   TH1D *h_PureKaonOther_stack_10 = new TH1D("h_PureKaonOther_stack_10","",4,0.2,0.6);
   ...
   h_errors_copy__3->SetEntries(1717);

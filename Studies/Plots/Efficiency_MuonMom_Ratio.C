...
//=========  (Wed Feb 21 08:49:44 2024) by ROOT version 6.12/06
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.625,-0.1123596,5.625,1.011236);
   pad1->SetFillColor(0);
   ...
   h_After_stack_2->SetEntries(5196);
   ...
   hs->Draw("nostack e0");
   TGaxis *gaxis = new TGaxis(5,0,5,1,0,0,510,"+L");

void invariant_mass_fhc_FV_muon_pion_pair_ByPureKaonType()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Feb  1 05:20:30 2024) by ROOT version 6.12/06
...
// ------------>Primitives in pad: p_plot
   ...
   p_plot->Draw();
   p_plot->cd();
   p_plot->Range(0.15,-1.379483,0.65,12.41534);
   ...
   h_errors__1->SetBinContent(1,1.981921);
   h_errors__1->SetBinContent(2,9.596111);
   h_errors__1->SetBinContent(3,3.475004);
   h_errors__1->SetBinContent(4,1.179588);
   h_errors__1->SetBinError(1,0.10262);
   h_errors__1->SetBinError(2,0.2258065);
   h_errors__1->SetBinError(3,0.1358834);
   h_errors__1->SetBinError(4,0.07916879);
   h_errors__1->SetMinimum(0);
   h_errors__1->SetMaximum(12.2774);
   h_errors__1->SetEntries(3091);
   ...
   hs_stack_1->SetMaximum(10.07592);
   ...
   h_PureKaonSignalNuMuCCKaon_stack_1->SetBinContent(1,0.04782115);
   h_PureKaonSignalNuMuCCKaon_stack_1->SetBinContent(2,0.2284788);
   h_PureKaonSignalNuMuCCKaon_stack_1->SetBinContent(3,0.07438846);
   h_PureKaonSignalNuMuCCKaon_stack_1->SetBinContent(4,0.01594038);
   h_PureKaonSignalNuMuCCKaon_stack_1->SetBinError(1,0.01594038);
   h_PureKaonSignalNuMuCCKaon_stack_1->SetBinError(2,0.03484269);
   h_PureKaonSignalNuMuCCKaon_stack_1->SetBinError(3,0.01988115);
   h_PureKaonSignalNuMuCCKaon_stack_1->SetBinError(4,0.009203185);
   h_PureKaonSignalNuMuCCKaon_stack_1->SetEntries(71);
   ...
   h_PureKaonSignalNuMuCCKaonMultiPion_stack_2->SetBinContent(1,0.05313461);
   h_PureKaonSignalNuMuCCKaonMultiPion_stack_2->SetBinContent(2,0.4357038);
   h_PureKaonSignalNuMuCCKaonMultiPion_stack_2->SetBinContent(3,0.1540904);
   h_PureKaonSignalNuMuCCKaonMultiPion_stack_2->SetBinContent(4,0.08501538);
   h_PureKaonSignalNuMuCCKaonMultiPion_stack_2->SetBinError(1,0.01680264);
   h_PureKaonSignalNuMuCCKaonMultiPion_stack_2->SetBinError(2,0.04811544);
   h_PureKaonSignalNuMuCCKaonMultiPion_stack_2->SetBinError(3,0.02861386);
   h_PureKaonSignalNuMuCCKaonMultiPion_stack_2->SetBinError(4,0.02125384);
   h_PureKaonSignalNuMuCCKaonMultiPion_stack_2->SetEntries(145);
   ...
   h_PureKaonSignalNuMuCCKaonHyperon_stack_3->SetBinContent(1,0.1594038);
   h_PureKaonSignalNuMuCCKaonHyperon_stack_3->SetBinContent(2,1.009558);
   h_PureKaonSignalNuMuCCKaonHyperon_stack_3->SetBinContent(3,0.4091365);
   h_PureKaonSignalNuMuCCKaonHyperon_stack_3->SetBinContent(4,0.13815);
   h_PureKaonSignalNuMuCCKaonHyperon_stack_3->SetBinError(1,0.02910302);
   h_PureKaonSignalNuMuCCKaonHyperon_stack_3->SetBinError(2,0.07324101);
   h_PureKaonSignalNuMuCCKaonHyperon_stack_3->SetBinError(3,0.04662543);
   h_PureKaonSignalNuMuCCKaonHyperon_stack_3->SetBinError(4,0.02709344);
   h_PureKaonSignalNuMuCCKaonHyperon_stack_3->SetEntries(323);
   ...
   h_PureKaonSignalNuMuCCKaonHyperonMultiPion_stack_4->SetBinContent(1,0.3878827);
   h_PureKaonSignalNuMuCCKaonHyperonMultiPion_stack_4->SetBinContent(2,1.854398);
   h_PureKaonSignalNuMuCCKaonHyperonMultiPion_stack_4->SetBinContent(3,0.8554672);
   h_PureKaonSignalNuMuCCKaonHyperonMultiPion_stack_4->SetBinContent(4,0.2284788);
   h_PureKaonSignalNuMuCCKaonHyperonMultiPion_stack_4->SetBinError(1,0.04539823);
   h_PureKaonSignalNuMuCCKaonHyperonMultiPion_stack_4->SetBinError(2,0.09926364);
   h_PureKaonSignalNuMuCCKaonHyperonMultiPion_stack_4->SetBinError(3,0.06742026);
   h_PureKaonSignalNuMuCCKaonHyperonMultiPion_stack_4->SetBinError(4,0.03484269);
   h_PureKaonSignalNuMuCCKaonHyperonMultiPion_stack_4->SetEntries(629);
   ...
   h_PureKaonOtherNuMuCC_stack_5->SetBinContent(1,0.6854365);
   h_PureKaonOtherNuMuCC_stack_5->SetBinContent(2,3.395302);
   h_PureKaonOtherNuMuCC_stack_5->SetBinContent(3,1.216783);
   h_PureKaonOtherNuMuCC_stack_5->SetBinContent(4,0.5047788);
   h_PureKaonOtherNuMuCC_stack_5->SetBinError(1,0.06034932);
   h_PureKaonOtherNuMuCC_stack_5->SetBinError(2,0.1343161);
   h_PureKaonOtherNuMuCC_stack_5->SetBinError(3,0.08040726);
   h_PureKaonOtherNuMuCC_stack_5->SetBinError(4,0.05178921);
   h_PureKaonOtherNuMuCC_stack_5->SetEntries(1104);
   ...
   h_PureKaonNuECC_stack_6->SetBinContent(1,0.01594038);
   h_PureKaonNuECC_stack_6->SetBinContent(2,0.1594038);
   h_PureKaonNuECC_stack_6->SetBinContent(3,0.03719423);
   h_PureKaonNuECC_stack_6->SetBinContent(4,0.005313461);
   h_PureKaonNuECC_stack_6->SetBinError(1,0.009203185);
   h_PureKaonNuECC_stack_6->SetBinError(2,0.02910302);
   h_PureKaonNuECC_stack_6->SetBinError(3,0.0140581);
   h_PureKaonNuECC_stack_6->SetBinError(4,0.005313461);
   h_PureKaonNuECC_stack_6->SetEntries(41);
   ...
   h_PureKaonNC_stack_7->SetBinContent(1,0.5313461);
   h_PureKaonNC_stack_7->SetBinContent(2,2.050996);
   h_PureKaonNC_stack_7->SetBinContent(3,0.5366596);
   h_PureKaonNC_stack_7->SetBinContent(4,0.1222096);
   h_PureKaonNC_stack_7->SetBinError(1,0.05313461);
   h_PureKaonNC_stack_7->SetBinError(2,0.1043929);
   h_PureKaonNC_stack_7->SetBinError(3,0.05339962);
   h_PureKaonNC_stack_7->SetBinError(4,0.02548246);
   h_PureKaonNC_stack_7->SetEntries(619);
   ...
   h_PureKaonOutFV_stack_8->SetBinContent(1,0.1009558);
   h_PureKaonOutFV_stack_8->SetBinContent(2,0.4622711);
   h_PureKaonOutFV_stack_8->SetBinContent(3,0.1912846);
   h_PureKaonOutFV_stack_8->SetBinContent(4,0.07970192);
   h_PureKaonOutFV_stack_8->SetBinError(1,0.02316084);
   h_PureKaonOutFV_stack_8->SetBinError(2,0.04956067);
   h_PureKaonOutFV_stack_8->SetBinError(3,0.03188077);
   h_PureKaonOutFV_stack_8->SetBinError(4,0.02057895);
   h_PureKaonOutFV_stack_8->SetEntries(159);
   ...
   h_errors__2->SetBinContent(1,1.981921);
   h_errors__2->SetBinContent(2,9.596111);
   h_errors__2->SetBinContent(3,3.475004);
   h_errors__2->SetBinContent(4,1.179588);
   h_errors__2->SetBinError(1,0.10262);
   h_errors__2->SetBinError(2,0.2258065);
   h_errors__2->SetBinError(3,0.1358834);
   h_errors__2->SetBinError(4,0.07916879);
   h_errors__2->SetMinimum(0);
   h_errors__2->SetMaximum(12.2774);
   h_errors__2->SetEntries(3091);
   ...
   h_errors_copy__3->SetBinContent(1,1.981921);
   h_errors_copy__3->SetBinContent(2,9.596111);
   h_errors_copy__3->SetBinContent(3,3.475004);
   h_errors_copy__3->SetBinContent(4,1.179588);
   h_errors_copy__3->SetBinError(1,0.10262);
   h_errors_copy__3->SetBinError(2,0.2258065);
   h_errors_copy__3->SetBinError(3,0.1358834);
   h_errors_copy__3->SetBinError(4,0.07916879);
   h_errors_copy__3->SetMinimum(0);
   h_errors_copy__3->SetMaximum(12.2774);
   h_errors_copy__3->SetEntries(3091);

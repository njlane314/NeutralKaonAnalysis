...
//=========  (Wed Nov 15 10:01:47 2023) by ROOT version 6.12/06
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.25,-119.1011,1.25,1071.91);
   pad1->SetFillColor(0);
   ...
   TH1F *hs_stack_6 = new TH1F("hs_stack_6","",10,-1,1);
   hs_stack_6->SetMinimum(0);
   hs_stack_6->SetMaximum(1060);
   ...
   h_Before_stack_1->SetBinContent(1,60);
   h_Before_stack_1->SetBinContent(2,98);
   h_Before_stack_1->SetBinContent(3,153);
   h_Before_stack_1->SetBinContent(4,169);
   h_Before_stack_1->SetBinContent(5,273);
   h_Before_stack_1->SetBinContent(6,423);
   h_Before_stack_1->SetBinContent(7,564);
   h_Before_stack_1->SetBinContent(8,743);
   h_Before_stack_1->SetBinContent(9,848);
   h_Before_stack_1->SetBinContent(10,652);
   ...
   h_After_stack_2->SetBinContent(1,15);
   h_After_stack_2->SetBinContent(2,16);
   h_After_stack_2->SetBinContent(3,29);
   h_After_stack_2->SetBinContent(4,27);
   h_After_stack_2->SetBinContent(5,62);
   h_After_stack_2->SetBinContent(6,104);
   h_After_stack_2->SetBinContent(7,147);
   h_After_stack_2->SetBinContent(8,174);
   h_After_stack_2->SetBinContent(9,200);
   h_After_stack_2->SetBinContent(10,98);
   ...
   hs->Draw("nostack e0");
   TGaxis *gaxis = new TGaxis(1,0,1,1060,0,0.3689988,510,"+L");
   ...
   Graph_Graph3001->SetMinimum(318.0534);
   Graph_Graph3001->SetMaximum(934.7224);

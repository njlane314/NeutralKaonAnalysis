...
void plot_muon_mom(){
    ...
    std::string label = "muon_mom_rhc_FV_muon";
    ...
    M.SetupHistograms(30,0,600,";Muon Candidate Track Length (cm);Events/bin");
    ...
    for(int i = 0; i < E.GetNEvents(); i++){
        ...
        double muon_mom = e.MuonCandidate.TrackLength;

        M.FillHistograms(e,muon_mom);               
    }

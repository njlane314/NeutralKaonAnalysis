...
void pion_mom_bias(){
    ...
    TH2F *hMuonMomVsLLRPID = new TH2F("hMuonMomVsLLRPDI", "", 50, -1, 1, 50, 1, 0);

    TH1F *hMuonMomentumBias1 = new TH1F("hMuonMomentumBias1", "", 50, -1, 1);
    TH1F *hMuonMomentumBias2 = new TH1F("hMuonMomentumBias2", "", 50, -1, 1);
    TH1F *hMuonMomentumBias3 = new TH1F("hMuonMomentumBias3", "", 50, -1, 1);
    TH1F *hMuonMomentumBias4 = new TH1F("hMuonMomentumBias4", "", 50, -1, 1);
    ...
    for(int i = 0; i < E.GetNEvents(); i++){
        ...
        for(size_t i = 0; i < e.TracklikePrimaryDaughters.size(); i++){
            ...
            if(abs(trackPDG) == 211){ // 13 muon, 211 pion, 2212 proton
                ...
                double bias = ( trackPionMomentum - trackTrueMomentum ) / trackTrueMomentum;
    ...
    hMuonMomentumBias1->SetLineColor(kAzure - 1);
    ...
    hMuonMomentumBias1->SetMaximum(0.25);
    hMuonMomentumBias1->SetMinimum(0);
    hMuonMomentumBias1->GetYaxis()->SetTitle("Arb. Units");
    hMuonMomentumBias1->GetXaxis()->SetTitle("(p_{#pi, reco} - p_{#pi, true}) / p_{#pi, true}");
    hMuonMomentumBias1->GetXaxis()->SetTitleSize(0.04);
    hMuonMomentumBias1->GetYaxis()->SetTitleSize(0.04);
    hMuonMomentumBias1->GetXaxis()->SetTitleOffset(1.15);
    hMuonMomentumBias1->GetYaxis()->SetTitleOffset(1.3);
    hMuonMomentumBias1->GetXaxis()->SetLabelSize(0.04);
    hMuonMomentumBias1->GetYaxis()->SetLabelSize(0.04);
    ...
    TLegend *legend = new TLegend(0.75, 0.65, 0.6, 0.85);

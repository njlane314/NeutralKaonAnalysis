#ifndef _EventAssembler2_cxx_
#define _EventAssembler2_cxx_

#include "EventAssembler2.h"

void EventAssembler2::SetFile(std::string infilename){
   ...
   t_in->SetBranchStatus("HasNeutronScatter",1);
   ...
   t_in->SetBranchAddress("HasNeutronScatter", &HasNeutronScatter);
...
Long64_t EventAssembler2::GetNEvents(){
...
Event2 EventAssembler2::GetEvent(int i){
   ...
   e.GoodReco = GoodReco;
   e.HasNeutronScatter = HasNeutronScatter;

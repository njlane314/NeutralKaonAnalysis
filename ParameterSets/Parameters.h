...
P_FHC_Tune_325_NoBDT.p_Max_Displacement=5;
...
P_FHC_Tune_325_NoBDT.p_AnalysisBDT_Cut=0.2;
...
P_RHC_Tune_397_NoBDT.p_Max_Displacement=5;
P_RHC_Tune_397_NoBDT.p_PID_Cut=0.6;
P_RHC_Tune_397_NoBDT.p_Proton_PID_Cut = 0.1;

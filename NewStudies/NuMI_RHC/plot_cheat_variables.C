...
void plot_cheat_variables(){
    ...
    M.SetupHistograms(20,-1,1,";Opening Angle Residual (fraction);Events/bin");
    ...
    for(int i = 0; i < E.GetNEvents(); i++){
        ...
        double res = (alpha - true_alpha)/true_alpha;
        //std::cout << res << std::endl;

        M.FillHistograms(e, res);               
    }

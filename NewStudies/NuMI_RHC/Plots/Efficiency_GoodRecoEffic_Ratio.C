void Efficiency_GoodRecoEffic_Ratio()
{
//=========Macro generated from canvas: c1/c1
//=========  (Thu Apr 18 06:04:20 2024) by ROOT version 6.12/06
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.125,-16.32927,1.125,146.9634);
   pad1->SetFillColor(0);
   ...
   hs->SetName("hs");
   hs->SetTitle("");
   hs->SetMaximum(145.3305);
   
   TH1F *hs_stack_2 = new TH1F("hs_stack_2","",1,0,1);
   hs_stack_2->SetMinimum(0);
   hs_stack_2->SetMaximum(145.3305);
   ...
   h_Before_stack_1->SetBinContent(1,116.2644);
   h_Before_stack_1->SetBinError(1,1.077539);
   ...
   h_After_stack_2->SetBinContent(1,22.92932);
   h_After_stack_2->SetBinError(1,0.4785256);
   h_After_stack_2->SetEntries(2296);
   ...
   hs->Draw("nostack e0");
   TGaxis *gaxis = new TGaxis(1,0,1,145.3305,0,0.2410814,510,"+L");
   ...
   Double_t Graph0_fx3002[1] = {
   0.5};
   Double_t Graph0_fy3002[1] = {
   118.8878};
   Double_t Graph0_felx3002[1] = {
   0};
   Double_t Graph0_fely3002[1] = {
   2.200259};
   Double_t Graph0_fehx3002[1] = {
   0};
   Double_t Graph0_fehy3002[1] = {
   2.220933};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(1,Graph0_fx3002,Graph0_fy3002,Graph0_felx3002,Graph0_fehx3002,Graph0_fely3002,Graph0_fehy3002);
   grae->SetName("Graph0");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph3002 = new TH1F("Graph_Graph3002","Graph",100,0.4,1.6);
   Graph_Graph3002->SetMinimum(116.2455);
   Graph_Graph3002->SetMaximum(121.5509);

void Efficiency_CorrectPair_Ratio()
{
...
// ------------>Primitives in pad: pad1
   ...
   TH1F *hs_stack_3 = new TH1F("hs_stack_3","",1,0,1);
   hs_stack_3->SetMinimum(0);
   hs_stack_3->SetMaximum(145.3305);
   ...
   h_After_stack_2->SetBinContent(1,21.92067);
   h_After_stack_2->SetBinError(1,0.4678821);
   h_After_stack_2->SetEntries(2195);
   ...
   hs->Draw("nostack e0");
   TGaxis *gaxis = new TGaxis(1,0,1,145.3305,0,0.2305967,510,"+L");
   ...
   Double_t Graph0_fx3003[1] = {
   0.5};
   Double_t Graph0_fy3003[1] = {
   118.8258};
   Double_t Graph0_felx3003[1] = {
   0};
   Double_t Graph0_fely3003[1] = {
   2.260765};
   Double_t Graph0_fehx3003[1] = {
   0};
   Double_t Graph0_fehy3003[1] = {
   2.283004};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(1,Graph0_fx3003,Graph0_fy3003,Graph0_felx3003,Graph0_fehx3003,Graph0_fely3003,Graph0_fehy3003);
   grae->SetName("Graph0");
   grae->SetTitle("Graph");
   ...
   TH1F *Graph_Graph3003 = new TH1F("Graph_Graph3003","Graph",100,0.4,1.6);
   Graph_Graph3003->SetMinimum(116.1106);
   Graph_Graph3003->SetMaximum(121.5631);

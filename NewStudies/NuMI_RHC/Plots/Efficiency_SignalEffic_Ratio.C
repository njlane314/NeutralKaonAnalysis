void Efficiency_SignalEffic_Ratio()
{
...
// ------------>Primitives in pad: pad1
   ...
   hs_stack_1->SetMaximum(145.3305);
   ...
   h_After_stack_2->SetBinContent(1,86.65404);
   h_After_stack_2->SetBinError(1,0.9302593);
   h_After_stack_2->SetEntries(8677);
   ...
   hs->Draw("nostack e0");
   TGaxis *gaxis = new TGaxis(1,0,1,145.3305,0,0.899184,510,"+L");
   ...
   TH1F *Graph_Graph3001 = new TH1F("Graph_Graph3001","Graph",100,0.4,1.6);
   Graph_Graph3001->SetMinimum(119.6811);
   Graph_Graph3001->SetMaximum(121.2386);

...
runsubrunlist=/exp/uboone/app/users/nlane/NeutralKaonAnalysis/NewStudies/NuMI_RHC/sample_bad_reco.txt

# The name of the sam def which you made the run subrun event list from
originalsamdef=cthorpe_make_k0s_events_numi_rhc_reco2_REAL_reco2_reco2
#originalsamdef=prodgenie_numi_uboone_overlay_rhc_mcc9_run3b_v28_v2_sample0

# choose a name for your sam def, any name as long as it doesnt already exist
newsamdef=nlane_18April

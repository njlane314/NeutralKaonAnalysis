...
*/
     ...
     // Setup Selector BDT Manager Object
      AnalysisBDTManager BDTManager("Test");
      BDTManager.SetupAnalysisBDT();

        std::cout << "BDT Setup" << std::endl;
      ...
      for(size_t i_s=0;i_s<SampleNames.size();i_s++){
         ...
         for(int i=0;i<E.GetNEvents();i++){
            ...
            //double score = BDTManager.CalculateScore(e);
            std::cout << BDTManager.CalculateScore(e) << std::endl;

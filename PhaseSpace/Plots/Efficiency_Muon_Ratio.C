...
// ------------>Primitives in pad: pad1
   ...
   hs_stack_2->SetMaximum(12.67982);
   ...
   h_After_stack_2->SetBinContent(1,0.1152711);
   h_After_stack_2->SetBinContent(2,2.19015);
   h_After_stack_2->SetBinContent(3,3.757837);
   h_After_stack_2->SetBinContent(4,3.527295);
   h_After_stack_2->SetBinContent(5,2.028771);
   h_After_stack_2->SetBinContent(6,1.544632);
   h_After_stack_2->SetBinContent(7,0.8068975);
   h_After_stack_2->SetBinContent(8,0.2305421);
   h_After_stack_2->SetBinContent(9,0.1613795);
   h_After_stack_2->SetBinContent(10,0.1152711);
   h_After_stack_2->SetBinError(1,0.05155079);
   h_After_stack_2->SetBinError(2,0.2247047);
   h_After_stack_2->SetBinError(3,0.2943365);
   h_After_stack_2->SetBinError(4,0.2851649);
   h_After_stack_2->SetBinError(5,0.2162677);
   h_After_stack_2->SetBinError(6,0.1887069);
   h_After_stack_2->SetBinError(7,0.1363906);
   h_After_stack_2->SetBinError(8,0.07290382);
   h_After_stack_2->SetBinError(9,0.06099571);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(10,0,10,12.67982,0,0.7721308,510,"+L");
   ...
   Graph_Graph3002->SetMinimum(2.286356);
   Graph_Graph3002->SetMaximum(11.31926);

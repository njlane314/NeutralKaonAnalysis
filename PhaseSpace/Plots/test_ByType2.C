...
// ------------>Primitives in pad: p_plot
   ...
   TH1D *h_errors__4 = new TH1D("h_errors__4","",2,0,2);
   h_errors__4->SetBinContent(2,38.8694);
   h_errors__4->SetBinError(2,0.9466274);
   h_errors__4->SetMinimum(0);
   h_errors__4->SetMaximum(49.77004);
   h_errors__4->SetEntries(1686);
   ...
   h_errors__4->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1F *hs_stack_8 = new TH1F("hs_stack_8","",2,0,2);
   hs_stack_8->SetMinimum(0);
   hs_stack_8->SetMaximum(41.80683);
   ...
   TH1D *h_ByType2_DirectLambda_stack_1 = new TH1D("h_ByType2_DirectLambda_stack_1","",2,0,2);
   h_ByType2_DirectLambda_stack_1->SetBinContent(2,38.8694);
   h_ByType2_DirectLambda_stack_1->SetBinError(2,0.9466274);
   h_ByType2_DirectLambda_stack_1->SetEntries(1686);
   h_ByType2_DirectLambda_stack_1->SetFillColor(8);

   ci = TColor::GetColor("#000099");
   h_ByType2_DirectLambda_stack_1->SetLineColor(ci);
   h_ByType2_DirectLambda_stack_1->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByType2_DirectHYP_stack_2 = new TH1D("h_ByType2_DirectHYP_stack_2","",2,0,2);
   ...
   h_ByType2_DirectHYP_stack_2->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByType2_Neutron_stack_3 = new TH1D("h_ByType2_Neutron_stack_3","",2,0,2);
   ...
   h_ByType2_Neutron_stack_3->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByType2_Dirt_stack_4 = new TH1D("h_ByType2_Dirt_stack_4","",2,0,2);
   ...
   h_ByType2_Dirt_stack_4->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByType2_RESLambda_stack_5 = new TH1D("h_ByType2_RESLambda_stack_5","",2,0,2);
   ...
   h_ByType2_RESLambda_stack_5->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByType2_RESHYP_stack_6 = new TH1D("h_ByType2_RESHYP_stack_6","",2,0,2);
   ...
   h_ByType2_RESHYP_stack_6->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByType2_Other_stack_7 = new TH1D("h_ByType2_Other_stack_7","",2,0,2);
   ...
   h_ByType2_Other_stack_7->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByType2_EXT_stack_8 = new TH1D("h_ByType2_EXT_stack_8","",2,0,2);
   ...
   h_ByType2_EXT_stack_8->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByType2_DISLambda_stack_9 = new TH1D("h_ByType2_DISLambda_stack_9","",2,0,2);
   h_ByType2_DISLambda_stack_9->SetFillColor(30);

   ci = TColor::GetColor("#000099");
   h_ByType2_DISLambda_stack_9->SetLineColor(ci);
   h_ByType2_DISLambda_stack_9->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByType2_DISHYP_stack_10 = new TH1D("h_ByType2_DISHYP_stack_10","",2,0,2);
   h_ByType2_DISHYP_stack_10->SetFillColor(15);

   ci = TColor::GetColor("#000099");
   h_ByType2_DISHYP_stack_10->SetLineColor(ci);
   h_ByType2_DISHYP_stack_10->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_errors__5 = new TH1D("h_errors__5","",2,0,2);
   h_errors__5->SetBinContent(2,38.8694);
   h_errors__5->SetBinError(2,0.9466274);
   h_errors__5->SetMinimum(0);
   h_errors__5->SetMaximum(49.77004);
   h_errors__5->SetEntries(1686);
   ...
   h_errors__5->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_errors_copy__6 = new TH1D("h_errors_copy__6","",2,0,2);
   h_errors_copy__6->SetBinContent(2,38.8694);
   h_errors_copy__6->SetBinError(2,0.9466274);
   h_errors_copy__6->SetMinimum(0);
   h_errors_copy__6->SetMaximum(49.77004);
   h_errors_copy__6->SetEntries(1686);
   ...
   h_errors_copy__6->GetXaxis()->SetTitle("Hyperon Multiplicity");

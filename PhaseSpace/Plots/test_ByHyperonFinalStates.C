...
// ------------>Primitives in pad: p_plot
   ...
   TH1D *h_errors__16 = new TH1D("h_errors__16","",2,0,2);
   h_errors__16->SetBinContent(2,38.8694);
   h_errors__16->SetBinError(2,0.9466274);
   h_errors__16->SetMinimum(0);
   h_errors__16->SetMaximum(49.77004);
   h_errors__16->SetEntries(1686);
   ...
   h_errors__16->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1F *hs_stack_12 = new TH1F("hs_stack_12","",2,0,2);
   hs_stack_12->SetMinimum(0);
   hs_stack_12->SetMaximum(41.80683);
   ...
   hs_stack_12->GetXaxis()->SetTitleSize(0.035);
   hs_stack_12->GetXaxis()->SetTitleFont(42);
   hs_stack_12->GetYaxis()->SetLabelFont(42);
   hs_stack_12->GetYaxis()->SetLabelSize(0.035);
   hs_stack_12->GetYaxis()->SetTitleSize(0.035);
   hs_stack_12->GetYaxis()->SetTitleOffset(0);
   ...
   TH1D *h_ByHyperonDecayChannel_SigmaPlus_stack_1 = new TH1D("h_ByHyperonDecayChannel_SigmaPlus_stack_1","",2,0,2);
   ...
   h_ByHyperonDecayChannel_SigmaPlus_stack_1->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByHyperonDecayChannel_Lambda_stack_2 = new TH1D("h_ByHyperonDecayChannel_Lambda_stack_2","",2,0,2);
   h_ByHyperonDecayChannel_Lambda_stack_2->SetBinContent(2,38.8694);
   h_ByHyperonDecayChannel_Lambda_stack_2->SetBinError(2,0.9466274);
   h_ByHyperonDecayChannel_Lambda_stack_2->SetEntries(1686);
   ...
   h_ByHyperonDecayChannel_Lambda_stack_2->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByHyperonDecayChannel_SigmaMinus_stack_3 = new TH1D("h_ByHyperonDecayChannel_SigmaMinus_stack_3","",2,0,2);
   ...
   h_ByHyperonDecayChannel_SigmaMinus_stack_3->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByHyperonDecayChannel_Kaon_stack_4 = new TH1D("h_ByHyperonDecayChannel_Kaon_stack_4","",2,0,2);
   ...
   h_ByHyperonDecayChannel_Kaon_stack_4->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_ByHyperonDecayChannel_Other_stack_5 = new TH1D("h_ByHyperonDecayChannel_Other_stack_5","",2,0,2);
   ...
   h_ByHyperonDecayChannel_Other_stack_5->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_errors__17 = new TH1D("h_errors__17","",2,0,2);
   h_errors__17->SetBinContent(2,38.8694);
   h_errors__17->SetBinError(2,0.9466274);
   h_errors__17->SetMinimum(0);
   h_errors__17->SetMaximum(49.77004);
   h_errors__17->SetEntries(1686);
   ...
   h_errors__17->GetXaxis()->SetTitle("Hyperon Multiplicity");
   ...
   TH1D *h_errors_copy__18 = new TH1D("h_errors_copy__18","",2,0,2);
   h_errors_copy__18->SetBinContent(2,38.8694);
   h_errors_copy__18->SetBinError(2,0.9466274);
   h_errors_copy__18->SetMinimum(0);
   h_errors_copy__18->SetMaximum(49.77004);
   h_errors_copy__18->SetEntries(1686);
   ...
   h_errors_copy__18->GetXaxis()->SetTitle("Hyperon Multiplicity");

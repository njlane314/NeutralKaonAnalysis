...
void MuonNuMIAngle(){
    ...
    for(int i = 0; i < E.GetNEvents(); i++){
        ...
        for(size_t i = 0; i < e.TracklikePrimaryDaughters.size(); i++){
            ...
            double trackFill = GetNuMIAngle(e.TracklikePrimaryDaughters.at(i).TrackDirectionX * e.TracklikePrimaryDaughters.at(i).MuonMomentum,
                                            e.TracklikePrimaryDaughters.at(i).TrackDirectionY * e.TracklikePrimaryDaughters.at(i).MuonMomentum,
                                            e.TracklikePrimaryDaughters.at(i).TrackDirectionZ * e.TracklikePrimaryDaughters.at(i).MuonMomentum);
    ...
    //c1->SetGrid();
    //c1->SetLogy();
    c1->SaveAs("Plots/MuonNuMIAngle.png");
